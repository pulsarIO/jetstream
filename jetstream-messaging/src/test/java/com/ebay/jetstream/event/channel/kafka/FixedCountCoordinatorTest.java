...
public class FixedCountCoordinatorTest {
	...
	public void testGetRebalanceCount() throws Exception {
		...
		ZkCoordinator zkCoordinator0 = new FixedCountCoordinator(3, topics1,
				groupId1, consumerId0, zkConnector);
		ZkCoordinator zkCoordinator1 = new FixedCountCoordinator(1, topics1,
		...
		assertTrue(topicCount1.get(topic0) == 1);
		assertTrue(topicCount1.get(topic1) == 1);

		zkCoordinator0.takePartition(topic0, 0);
		zkCoordinator1.takePartition(topic1, 0);
		zkCoordinator1.takePartition(topic1, 1);
	...
	public void testGetToTakePartitions() throws Exception {
		...
		ZkCoordinator zkCoordinator2 = new FixedCountCoordinator(3, topics2,
	...
	public void testGetToReleasePartitions() throws Exception {
		...
		ZkCoordinator zkCoordinator3 = new FixedCountCoordinator(3, topics3,
